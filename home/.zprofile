...
# A bare `alias` on the next line printed every defined alias on each
# interactive shell start, because ~/.zshrc sources this file. Commented out
# on 2026-09-19 while adopting this file into version control. Re-enable only
# if that output is wanted on purpose.
# alias
alias gc="cz c"
