...
-- Set the x delete key to not copy to the system clipboard
...
-- vim.keymap.set("n", "k", "kzz") -- Move cursor up and center the screen

-- Position cursor at the middle of the screen after searching
-- vim.keymap.set("n", "n", "nzz") -- Keep cursor in the middle when searching forward
-- vim.keymap.set("n", "N", "Nzz") -- Keep cursor in the middle when searching backward
...
vim.keymap.set("v", "J", ":move '>+1<CR>gv=gv", { desc = "Move line down in visual mode" })
vim.keymap.set("v", "K", ":move '<-2<CR>gv=gv", { desc = "Move line up in visual mode" })
...
vim.keymap.set("n", "<leader>tl", "<cmd>VimtexCompile<CR>", { desc = "Start compiling LaTeX" })
vim.keymap.set("n", "<leader>tv", "<cmd>VimtexView<CR>", { desc = "View compiled PDF" })
vim.keymap.set("n", "<leader>tk", "<cmd>VimtexStop<CR>", { desc = "Stop LaTeX compilation" })
vim.keymap.set("n", "<leader>q", ":!zathura <C-r ≥ expand ('%:r') <cr> - pdf &<cr>", { desc = "Open Zathura" })
...
vim.keymap.set("n", "<leader>odl", "<cmd>ObsidianDailies<CR>", { desc = "List Dailies" })
vim.keymap.set("n", "<leader>odt", "<cmd>ObsidianToday<CR>", { desc = "Create/Open Today Daily Note" })
vim.keymap.set("n", "<leader>odm", "<cmd>ObsidianTomorrow<CR>", { desc = "Create/Open Tomorrow Daily Note" })
vim.keymap.set("n", "<leader>ody", "<cmd>ObsidianYesterday<CR>", { desc = "Create/Open Yesterday Daily Note" })
