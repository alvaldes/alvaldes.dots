...
return {
  {
    ...
    opts = {
      ...
      workspaces = {
        {
          name = "alvaldesNotes",
          path = "/Users/alvaldes/Documents/alvaldes-notes/alvaldesNotes",
        },
      },
      ...
      mappings = {
        -- Mapeo para crear una Daily Note usando un template específico
        ["<leader>odn"] = {
          action = function()
            return require("obsidian").commands.new_daily_note("daily-note")
          end,
          opts = { buffer = true },
        },
        -- "Obsidian follow"
